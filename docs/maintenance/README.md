...
| [subscription-open-issues.md](./subscription-open-issues.md) | 구독·용량 한도 미해결 이슈 — 한도 설계 모순, 그룹 수 제한, 해지 대응, AI 계량 준비 | [features/17-subscription.md](../features/17-subscription.md) |
| [storage-buckets.md](./storage-buckets.md) | R2 버킷 구성 — 공개/비공개 분리 기준, prefix별 소속, 업로드 검증 규칙 | — |
